      ...
      <div style={{ maxWidth: 380, width: "100%" }}>
        ...
        {armoryStep === "intro" && (
          <div style={{ animation: "fadeIn 0.6s ease-out" }}>
            ...
            <PixelText size={7} color={C.subtleText} style={{ display: "block", marginBottom: 20 }}>Tools for the Inner Storm</PixelText>
        ...
        {armoryStep === "learn" && (
          <div style={{ animation: "fadeIn 0.6s ease-out" }}>
            ...
            <PixelText size={7} color={C.subtleText} style={{ display: "block", marginBottom: 16 }}>The Steady Breath — Your First Armory Tool</PixelText>
            <DialogBox speaker="DARA">
              <PixelText size={8} color={C.cream} style={{ display: "block", lineHeight: 1.9 }}>
        ...
        {armoryStep === "ready" && (
          <div style={{ animation: "fadeIn 0.6s ease-out" }}>
            ...
            <button onClick={onContinue} style={{
              ...
              <PixelText size={6} color={C.subtleText}>Skip the practice?</PixelText>
            </button>
          </div>
        )}
        ...
        {armoryStep === "practice" && (
          <div style={{ animation: "fadeIn 0.6s ease-out" }}>
            <div style={{ marginBottom: 16 }}>
              ...
              <PixelText size={7} color={C.subtleText} style={{ display: "block" }}>{formatTime(totalElapsed)} / {formatTime(practiceDuration)}</PixelText>
            </div>
            ...
            <DialogBox speaker="DARA">
              <PixelText size={7} color={C.subtleText} style={{ display: "block", lineHeight: 1.7 }}>
            ...
            <button onClick={onContinue} style={{ width: "100%", marginTop: 10, padding: 10, background: "transparent", border: `1px dashed ${C.mutedBorder}`, borderRadius: 4, cursor: "pointer" }}><PixelText size={6} color={C.subtleText}>Skip the practice ?</PixelText></button>
          </div>
        )}
        ...
        {armoryStep === "complete" && (
          <div style={{ animation: "fadeIn 0.6s ease-out" }}>
            ...
            <div style={{ background: C.teal + "10", border: "2px solid " + C.teal + "30", borderRadius: 8, padding: C.padLg, marginBottom: 16 }}>
