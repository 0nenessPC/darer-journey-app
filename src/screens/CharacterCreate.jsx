...
export default function CharacterCreate({
  ...
  const setNameConfirmed = (v) =>
    setOBState({ nameConfirmed: typeof v === 'function' ? v(nameConfirmed) : v });
    ...
    [
      {
        id: 'a1',
        word: 'Acceptance',
        desc: 'Open to and accepting of myself, others, and life',
        icon: '🌿',
        dim: 'resilience',
      },
      {
        id: 'a2',
        word: 'Adventure',
        desc: 'Actively seeking, creating, or exploring novel experiences',
        icon: '🧭',
        dim: 'courage',
      },
      {
        id: 'a3',
        word: 'Assertiveness',
        desc: 'Standing up for myself and asking for what I want',
        icon: '🗣',
        dim: 'courage',
      },
      {
        id: 'a4',
        word: 'Authenticity',
        desc: 'Being genuine, real, and true to who I am',
        icon: '💎',
        dim: 'openness',
      },
      {
        id: 'a5',
        word: 'Caring',
        desc: 'Being caring toward myself and others',
        icon: '💛',
        dim: 'openness',
      },
      {
        id: 'a6',
        word: 'Challenge',
        desc: 'Pushing myself to grow, learn, and improve',
        icon: '⚡',
        dim: 'courage',
      },
      {
        id: 'a7',
        word: 'Compassion',
        desc: 'Responding with kindness to those who are struggling',
        icon: '🤲',
        dim: 'resilience',
      },
      {
        id: 'a8',
        word: 'Connection',
        desc: "Being fully present with others in what I'm doing",
        icon: '🔗',
        dim: 'openness',
      },
      {
        id: 'a9',
        word: 'Cooperation',
        desc: 'Being cooperative and collaborative with others',
        icon: '🧩',
        dim: 'openness',
      },
      {
        id: 'a10',
        word: 'Courage',
        desc: 'Being brave and persisting in the face of fear',
        icon: '⚔️',
        dim: 'courage',
      },
      {
        id: 'a11',
        word: 'Curiosity',
        desc: 'Being open-minded, interested, willing to explore',
        icon: '🔍',
        dim: 'openness',
      },
      {
        id: 'a12',
        word: 'Fairness',
        desc: 'Treating myself and others with fairness and justice',
        icon: '⚖️',
        dim: 'openness',
      },
      {
        id: 'a13',
        word: 'Flexibility',
        desc: 'Adjusting and adapting readily to changing circumstances',
        icon: '🌊',
        dim: 'resilience',
      },
      {
        id: 'a14',
        word: 'Forgiveness',
        desc: 'Being forgiving toward myself or others',
        icon: '🕊',
        dim: 'resilience',
      },
      {
        id: 'a15',
        word: 'Friendliness',
        desc: 'Being warm, open, and approachable toward others',
        icon: '🤝',
        dim: 'openness',
      },
      {
        id: 'a16',
        word: 'Fun',
        desc: 'Seeking, creating, and engaging in fun-filled activities',
        icon: '🎉',
        dim: 'openness',
      },
      {
        id: 'a17',
        word: 'Generosity',
        desc: 'Being generous, sharing, and giving to myself or others',
        icon: '🎁',
        dim: 'openness',
      },
      {
        id: 'a18',
        word: 'Honesty',
        desc: 'Being truthful and sincere with myself and others',
        icon: '✨',
        dim: 'openness',
      },
      {
        id: 'a19',
        word: 'Humility',
        desc: 'Being modest; letting my actions speak for themselves',
        icon: '🌱',
        dim: 'resilience',
      },
      {
        id: 'a20',
        word: 'Humour',
        desc: 'Seeing and appreciating the humorous side of life',
        icon: '😄',
        dim: 'openness',
      },
      {
        id: 'a21',
        word: 'Independence',
        desc: 'Choosing for myself how I live and what I do',
        icon: '🦅',
        dim: 'courage',
      },
      {
        id: 'a22',
        word: 'Intimacy',
        desc: 'Opening up and sharing myself in close relationships',
        icon: '❤️',
        dim: 'openness',
      },
      {
        id: 'a23',
        word: 'Kindness',
        desc: 'Being considerate, helpful, or caring to myself or others',
        icon: '🌸',
        dim: 'openness',
      },
      {
        id: 'a24',
        word: 'Love',
        desc: 'Showing love and affection to myself or others',
        icon: '💜',
        dim: 'openness',
      },
      {
        ...
        desc: "Seeing things from others' points of view",
        icon: '🌏',
        dim: 'openness',
      },
      {
        id: 'a26',
        word: 'Order',
        desc: 'Being orderly, organized, and structured',
        icon: '📐',
        dim: 'resilience',
      },
      {
        id: 'a27',
        word: 'Patience',
        desc: 'Waiting calmly for what I want',
        icon: '⏳',
        dim: 'resilience',
      },
      {
        id: 'a28',
        word: 'Persistence',
        desc: 'Continuing resolutely despite problems or difficulties',
        icon: '🔥',
        dim: 'resilience',
      },
      {
        id: 'a29',
        word: 'Reciprocity',
        desc: 'Building relationships with a fair balance of giving and taking',
        icon: '🔄',
        dim: 'openness',
      },
      {
        id: 'a30',
        word: 'Respect',
        desc: 'Being polite, considerate, and showing positive regard',
        icon: '🙏',
        dim: 'openness',
      },
      {
        id: 'a31',
        word: 'Self-awareness',
        desc: 'Being aware of my own thoughts, feelings, and actions',
        icon: '🪞',
        dim: 'resilience',
      },
      {
        id: 'a32',
        word: 'Sensuality',
        desc: 'Creating and enjoying experiences that stimulate the senses',
        icon: '🌺',
        dim: 'openness',
      },
      {
        id: 'a33',
        word: 'Sexuality',
        desc: 'Exploring and expressing my sexuality freely',
        icon: '💋',
        dim: 'openness',
      },
      {
        id: 'a34',
        word: 'Supportiveness',
        desc: 'Being helpful, encouraging, and available to others',
        icon: '🛡',
        dim: 'openness',
      },
      {
        id: 'a35',
        word: 'Trust',
        desc: 'Being loyal, faithful, sincere, and reliable',
        icon: '🤝',
        dim: 'openness',
      },
  ...
  return (
    <div
      style={{
        ...
        justifyContent: step === 'reveal' ? 'flex-start' : 'center',
        alignItems: 'center',
        padding: step === 'reveal' ? '16px 24px 0' : '0 24px',
        background: C.mapBg,
        textAlign: 'center',
        overflowY: step === 'reveal' ? 'auto' : 'hidden',
      }}
    >
      {/* STEP 1: NAME */}
      {step === 'name' && (
        <div style={{ animation: 'fadeIn 0.5s ease-out', width: '100%' }}>
          <div
            style={{
              ...
              borderRadius: 6,
              background: C.cardBg,
              border: `4px solid ${nameConfirmed ? C.goldMd : C.mutedBorder}`,
              display: 'flex',
              alignItems: 'center',
          ...
          <input
            ...
            style={{
              ...
              textAlign: 'center',
              background: C.cardBg,
              border: `3px solid ${nameConfirmed ? C.goldMd : C.mutedBorder}`,
              borderRadius: 4,
              color: C.cream,
              fontSize: 16,
      ...
      {step === 'meetDara' && (
        <div style={{ width: '100%', animation: 'fadeIn 0.6s ease-out' }}>
          ...
          <PixelBtn
            onClick={() => onComplete(name.trim() || darerId, defaultStats, [], null, [])}
            color={C.gold}
            ...
            >
              ...
              >
                ...
                <div style={{ display: 'flex', gap: 8, marginBottom: 14 }}>
                  {[0, 1, 2].map((i) => {
                    const picked = coreValues[i]
                      ? ACT_VALUES.find((v) => v.id === coreValues[i])
                      : null;
                    return (
                      <div
                        key={i}
                        ...
                        onClick={() =>
                          picked && setCoreValues((prev) => prev.filter((x) => x !== picked.id))
                        }
                      >
                        {picked ? (
                          <>
                            ...
                            <PixelText size={7} color={C.goldMd}>
                              {picked.word.toUpperCase()}
                            </PixelText>
                          </>
                        ) : (
                          <PixelText size={10} color={C.mutedBorder}>
                            ?
                          </PixelText>
                        )}
                      </div>
                ...
                {ACT_VALUES.map((v) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        padding: '14px 10px',
                        background: active ? C.goldMd + '15' : 'C.cardBg',
                    ...
                    >
                      ...
                      <PixelText size={8} color={active ? C.goldMd : C.cream}>
                        {v.word.toUpperCase()}
                      </PixelText>
                      {expanded && (
      ...
      {step === 'reveal' && stats && (
        ...
        >
          ...
          <PixelText
            size={7}
            color={C.grayLt}
            style={{ display: 'block', marginTop: 4, marginBottom: 20 }}
          >
          ...
          {(() => {
            ...
            const chosenVals = coreValues
              .map((id) => ACT_VALUES.find((v) => v.id === id))
              .filter(Boolean);
            const assigned = [];
            const usedDims = new Set();
            // First pass: assign each value to its natural dimension if available
            chosenVals.forEach((v) => {
              if (!usedDims.has(v.dim)) {
                assigned.push({ ...v, assignedDim: v.dim });
                usedDims.add(v.dim);
              }
            });
            ...
            chosenVals.forEach((v) => {
              if (!assigned.find((a) => a.id === v.id)) {
                ...
                if (freeDim) {
                  assigned.push({ ...v, assignedDim: freeDim });
                  usedDims.add(freeDim);
                }
              }
            });
            ...
            return assigned.map((v, i) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    <PixelText size={8} color={colors[v.assignedDim]}>
                      {v.word.toUpperCase()}
                    </PixelText>
                    <PixelText size={8} color={C.cream}>
                      {stats[v.assignedDim]}/10
                    </PixelText>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    <div
                      style={{
                        height: '100%',
                        width: statsRevealed ? `${stats[v.assignedDim] * 10}%` : '0%',
                        background: colors[v.assignedDim],
                        borderRadius: 2,
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
            <button
              ...
              style={{
                flex: 1,
                padding: 10,
                background: showTooltip === 'strength' ? C.goldMd + '15' : 'C.cardBg',
            ...
            >
              <PixelText size={12} color={C.goldMd}>
                0
              </PixelText>
              <div>
                <PixelText size={6} color={C.grayLt}>
            ...
            <button
              onClick={() => setShowTooltip(showTooltip === 'challenge' ? null : 'challenge')}
              style={{
                flex: 1,
                padding: 10,
                background: showTooltip === 'challenge' ? C.plumMd + '15' : 'C.cardBg',
            ...
            >
              <PixelText size={12} color={C.plumMd}>
                0
              </PixelText>
              <div>
                <PixelText size={6} color={C.grayLt}>
          ...
          {showTooltip && (
            ...
            >
              <PixelText
                size={8}
                color={showTooltip === 'strength' ? C.goldMd : C.plumMd}
              ...
              <PixelText size={8} color={C.cream} style={{ display: 'block', lineHeight: 1.8 }}>
                ...
                {(() => {
                  const chosenVals = coreValues
                    .map((id) => ACT_VALUES.find((v) => v.id === id))
                    .filter(Boolean);
                  const highest = chosenVals.reduce(
                    (best, v) => (!best || stats[v.dim] > stats[best.dim] ? v : best),
                    null,
                  );
                  return highest
                    ? `Your ${highest.word.toLowerCase()} shines through — the Shadow hasn't been able to dim that.`
                    : 'I can see the fight in you already.';
                })()}{' '}
          ...
          <PixelBtn
            onClick={() =>
              onComplete(
                ...
                [],
                null,
                coreValues.map((id) => ACT_VALUES.find((v) => v.id === id)),
              )
            }
            color={C.gold}
            textColor={C.charcoal}
