...
const ALLY_VICTORIES = [
  {
    ...
    outcome: 'victory',
    date: '2h ago',
    note: 'I spoke up for the first time in months.',
  },
  {
    id: 2,
    hero: 'DARER_197',
    ...
    outcome: 'victory',
    date: '4h ago',
    note: 'Made eye contact with the barista. Stayed.',
  },
  {
    id: 3,
    hero: 'DARER_514',
    boss: 'Party Invitation',
    sudsBefore: 90,
    sudsAfter: 55,
    outcome: 'partial',
    date: '6h ago',
    note: 'Went for 20 minutes. Left early but I went.',
  },
  {
    id: 4,
    hero: 'DARER_728',
    ...
    outcome: 'victory',
    date: '8h ago',
    note: "Called a friend I've been avoiding. We talked for an hour.",
  },
  {
    id: 5,
    hero: 'DARER_043',
    boss: 'Restaurant Alone',
    sudsBefore: 75,
    sudsAfter: 30,
    outcome: 'victory',
    date: '12h ago',
    note: 'Ate alone without looking at my phone.',
  },
  {
    id: 6,
    hero: 'DARER_661',
    boss: 'The Presentation',
    sudsBefore: 95,
    sudsAfter: 50,
    outcome: 'victory',
    date: '1d ago',
    note: "Presented to 30 people. My hands shook but my voice didn't.",
  },
  {
    id: 7,
    hero: 'DARER_889',
    ...
    outcome: 'victory',
    date: '1d ago',
    note: 'Sent a message in the group chat instead of lurking.',
  },
  {
    id: 8,
    hero: 'DARER_305',
    ...
    outcome: 'victory',
    date: '1d ago',
    note: "Took the elevator with 3 strangers. Didn't look down.",
  },
  {
    id: 9,
    hero: 'DARER_472',
    ...
    outcome: 'partial',
    date: '2d ago',
    note: 'Asked a stranger for directions. They were nice.',
  },
  {
    id: 10,
    hero: 'DARER_916',
    ...
    outcome: 'victory',
    date: '2d ago',
    note: 'Gave someone a genuine compliment. It felt good.',
  },
  {
    id: 11,
    hero: 'DARER_233',
    boss: 'Networking Event',
    sudsBefore: 88,
    sudsAfter: 60,
    outcome: 'partial',
    date: '2d ago',
    note: 'Talked to one person. That was enough.',
  },
  {
    id: 12,
    hero: 'DARER_774',
    ...
    outcome: 'victory',
    date: '3d ago',
    note: "Said no to something I didn't want to do. The world didn't end.",
  },
];
          ...
          >
            ...
            {v.note && (
              <PixelText
                size={7}
                color={C.grayLt}
                style={{ display: 'block', fontStyle: 'italic', lineHeight: 1.8 }}
              >
                "{v.note}"
              </PixelText>
            )}
